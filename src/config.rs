...
impl ConfigBuilder {
  pub fn new() -> ConfigBuilder {
    ConfigBuilder {
      ...
      exclude_landuse: vec!["allotments".to_string(), "commercial".to_string(), "industrial".to_string(), "military".to_string(), "retail".to_string()],
  ...
  pub fn level_threshold(mut self, level_threshold: i32) -> ConfigBuilder {
